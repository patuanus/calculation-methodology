classdef DoAn_Nhom10 < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        PhmAnhTunLabel                 matlab.ui.control.Label
        inhLmQuangTunLabel             matlab.ui.control.Label
        MSSVLabel                      matlab.ui.control.Label
        Label                          matlab.ui.control.Label
        Label_2                        matlab.ui.control.Label
        NhimvLabel                     matlab.ui.control.Label
        CodethitkgiaodinGUILabel       matlab.ui.control.Label
        ChunbbocokimthchcnngcathuttonLabel  matlab.ui.control.Label
    end
            ...
            if strcmp(pp, "XapXiLui")
                ...
                if strcmp(pp1,"NhapChuoi")
                    ...
                    if strcmp(pp2,"O(h^2)")
                        ...
                        if(position_b - 2 == 0)
                            uialert(app.UIFigure, 'Vui lòng nhÿp lÿi giá trÿ ÿÿo hàm sao cho X(i - 2) > 0 ','Lÿi nhÿp liÿu', 'Icon', 'error');
                        else
            ...
            %%%%% Trung tam
                if strcmp(pp, "TrungTam")
                    ...
                    if strcmp(pp1,"NhapChuoi")
                        ...
                        if strcmp(pp2, "O(h)")
                            uialert(app.UIFigure, 'Invalid undentified O(h) ','Lÿi nhÿp liÿu', 'Icon', 'error');
                        end
                    end
                end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.ChnphngthcnisuyDropDownLabel.Text = 'Chÿn phÿÿng thÿc nÿi suy';
            ...
            app.ButtonNoiSuy.Text = 'Tính nÿi suy';
            ...
            app.NhpdliuxEditFieldLabel_2.Text = 'Nhÿp dÿ liÿu x';
            ...
            title(app.UIAxes3, 'ÿÿ thÿ hÿi quy')
            ...
            app.NhpdliuYLabel.Text = 'Nhÿp dÿ liÿu Y';
            ...
            app.ChnphngthchiquyDropDownLabel.Text = 'Chÿn phÿÿng thÿc hÿi quy';
            ...
            app.KtquphuongtrnhhiquyEditFieldLabel.Text = 'Kÿt quÿ phuong trình hÿi quy';
            ...
            app.NhpdliuxEditFieldLabel_3.Text = 'Nhÿp dÿ liÿu x';
            ...
            app.NhphmsEditFieldLabel_2.Text = 'Nhÿp hàm sÿ';
            ...
            app.ChnphngphpohmDropDownLabel.Text = 'Chÿn phÿÿng pháp ÿÿo hàm ';
            ...
            app.ChncchnhpDropDownLabel_2.Text = 'Chÿn cách nhÿp';
            ...
            app.NhpgitrsaisDropDownLabel.Text = 'Nhÿp giá trÿ sai sÿ';
            ...
            app.NhpgitrcntnhohmEditFieldLabel_2.Text = 'Nhÿp giá trÿ cÿn tính ÿÿo hàm';
            ...
            app.NhpdliuxEditFieldLabel_4.Text = 'Nhÿp dÿ liÿu x';
            ...
            app.NhpdliuyEditFieldLabel_2.Text = 'Nhÿp dÿ liÿu y';
            ...
            app.ChnphngphptchphnDropDownLabel.Text = 'Chÿn phÿÿng pháp tích phân';
            ...
            app.NhpcnaEditFieldLabel.Text = 'Nhÿp cÿn a';
            ...
            app.NhpcnbEditFieldLabel.Text = 'Nhÿp cÿn b';
            ...
            app.NhphmsEditFieldLabel_3.Text = 'Nhÿp hàm sÿ';
            ...
            app.ButtonTichPhan.Text = 'Tính tích phân';
            ...
            app.ChncchnhpDropDownLabel.Text = 'Chÿn cách nhÿp';
            ...
            app.GiithiuNhmTab.Title = 'Giÿi thiÿu Nhóm';

            % Create ThnhvinLabel
            app.ThnhvinLabel = uilabel(app.GiithiuNhmTab);
            app.ThnhvinLabel.Position = [51 269 65 22];
            app.ThnhvinLabel.Text = 'Thành viên';

            % Create PhmAnhTunLabel
            app.PhmAnhTunLabel = uilabel(app.GiithiuNhmTab);
            app.PhmAnhTunLabel.Position = [20 240 91 22];
            app.PhmAnhTunLabel.Text = 'Phÿm Anh Tuÿn';

            % Create inhLmQuangTunLabel
            app.inhLmQuangTunLabel = uilabel(app.GiithiuNhmTab);
            app.inhLmQuangTunLabel.Position = [20 206 127 22];
            app.inhLmQuangTunLabel.Text = 'ÿinh Lâm Quang Tuÿn';

            % Create MSSVLabel
            app.MSSVLabel = uilabel(app.GiithiuNhmTab);
            app.MSSVLabel.Position = [177 269 39 22];
            app.MSSVLabel.Text = 'MSSV';

            % Create Label
            app.Label = uilabel(app.GiithiuNhmTab);
            app.Label.Position = [167 240 59 22];
            app.Label.Text = '22200178';

            % Create Label_2
            app.Label_2 = uilabel(app.GiithiuNhmTab);
            app.Label_2.Position = [167 206 59 22];
            app.Label_2.Text = '22200176';

            % Create NhimvLabel
            app.NhimvLabel = uilabel(app.GiithiuNhmTab);
            app.NhimvLabel.Position = [385 269 56 22];
            app.NhimvLabel.Text = 'Nhiÿm vÿ';

            % Create CodethitkgiaodinGUILabel
            app.CodethitkgiaodinGUILabel = uilabel(app.GiithiuNhmTab);
            app.CodethitkgiaodinGUILabel.Position = [314 240 156 22];
            app.CodethitkgiaodinGUILabel.Text = 'Code, thiÿt kÿ giao diÿn GUI';

            % Create ChunbbocokimthchcnngcathuttonLabel
            app.ChunbbocokimthchcnngcathuttonLabel = uilabel(app.GiithiuNhmTab);
            app.ChunbbocokimthchcnngcathuttonLabel.Position = [314 206 296 22];
            app.ChunbbocokimthchcnngcathuttonLabel.Text = 'Chuÿn bÿ báo cáo, kiÿm thÿ chÿc nÿng cÿa thuÿt toán';
